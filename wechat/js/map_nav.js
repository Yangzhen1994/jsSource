// 百度地图API功能 公租房小区展示（12缩放）
var map = new BMap.Map("allmap");
map.centerAndZoom(new BMap.Point(113.482279,23.165242),12);//确定中心点，以及初始的缩放倍数
...
var phArr = [
    ...
    {name:"保利瀚林花园",jwd:"113.44729,23.108349",href:"http://www.baidu.com/"}
]
...
ComplexCustomOverlay.prototype.initialize = function(map){
    ...
    div.href = this._href;//覆盖物超链接
    div.ontouchend=function(){window.location.href=this.getAttribute("href");}
...
ComplexCustomOverlay.prototype.draw = function(){
    ...
    switch(this._num){
        ...
        case 1:
            this._div.style.left = pixel.x - 35 + "px";
            this._div.style.top  = pixel.y - 101 + "px";
            break;
        case 2:
