 ...
 * @param {Function} options.shadowback 选择阴影后的回调函数
...
(function() {
    ...
    Layer.prototype = {
        ...
        bindEvent: function () {
            ...
            this.el.addEventListener('click', function(e) {
                ...
                self.opts.shadowback && self.opts.shadowback();
    ...
    function IosSelect(level, data, options) {
        ...
        this.options.shadowback = options.shadowback;
